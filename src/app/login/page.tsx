    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-background to-muted/20 px-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold tracking-tight">LinkToss</h1>
        ...
        <div className="grid grid-cols-3 gap-4 pt-8">
          <div className="text-center">
            ...
            <h3 className="font-semibold">체계적 정리</h3>
          ...
          <div className="text-center">
            <div className="mb-2 text-3xl">📝</div>
            <h3 className="font-semibold">풍부한 문서화</h3>
            <p className="mt-1 text-xs text-muted-foreground">
              마크다운 노트 작성
            </p>
          </div>
